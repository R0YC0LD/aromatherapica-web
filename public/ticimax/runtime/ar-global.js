(function (window, document) {
  ...
  (function ensureFreshStyles() {
    ...
    link.rel = "stylesheet";
    link.href = base + "ar-global.css?v=20260801-5";
  ...
  api.buildExactShell = function () {
    ...
    if (nativeHeader && !api.qs("#ar-exact-header")) {
      ...
      header.innerHTML = '<div class="ar-topline"><a href="/aromaterapi-yaglari">Saf aromaterapi yağlarını keşfedin <span>→</span></a><a href="/urunler">Tüm siparişlerde ücretsiz kargo <span>→</span></a></div><div class="header-main"><nav class="ar-head-nav" aria-label="Ana menü"><button class="ar-head-button" data-ar-menu aria-label="Menüyü aç"><i class="ar-i ar-i-menu"></i></button><a href="/aromaterapi-yaglari">Aromaterapi</a><a href="/ozel-bakim-urunleri">Özel Bakım</a><a href="/cilt-bakimi">Cilt Bakımı</a><a href="/hakkimizda">Markamız</a></nav><a class="ar-wordmark" href="/" aria-label="Aromatherapica ana sayfa"><img src="https://r0yc0ld.github.io/aromatherapica-web/aromatherapica-emblem.png" alt=""><span><strong>Aromatherapica</strong><small>Essential Oils &amp; Aromatherapy</small></span></a><div class="ar-head-actions"><button class="ar-head-button" data-ar-search aria-label="Arama yap"><i class="ar-i ar-i-search"></i></button><a class="ar-head-button ar-account" href="/Hesabim" aria-label="Hesabım"><i class="ar-i ar-i-user"></i></a><a class="ar-head-button" href="/favorilerim" aria-label="İstek listesi"><i class="ar-i ar-i-heart"></i></a><button class="ar-head-button" data-ar-cart aria-label="Sepeti aç"><i class="ar-i ar-i-bag"></i><b class="ar-cart-badge">0</b></button></div></div><nav class="ar-category-nav" aria-label="Ürün kategorileri"><a href="/aromaterapi-yaglari">Uçucu Yağlar</a><a href="/cilt-bakimi">Cilt Bakımı</a><a href="/ozel-bakim-urunleri">Özel Bakım</a><a href="/sacvevucut-bakimi">Saç Bakımı</a><a href="/sacvevucut-bakimi">Vücut Bakımı</a><a href="/arama?q=gül+suyu">Gül Suları</a><a href="/arama?q=taşıyıcı+yağ">Taşıyıcı Yağlar</a><a href="/arama?q=hediye">Hediye</a></nav>';
